...
import { GlobeIcon, LightbulbIcon, TelescopeIcon, TabsIcon } from './icons';
...
const suggestions = [
    ...
    { text: "Compare phone plans and pick the best deal", icon: <TelescopeIcon className="w-5 h-5 text-gray-300" /> },
    { text: "Find movies and shows I recently viewed", icon: <TabsIcon className="w-5 h-5 text-gray-300" /> },
];
